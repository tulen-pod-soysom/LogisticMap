...
// LogisticMap.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLogisticMapApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLogisticMapApp

CLogisticMapApp::CLogisticMapApp()
{
...
// Единственный объект CLogisticMapApp

CLogisticMapApp theApp;


// Инициализация CLogisticMapApp

BOOL CLogisticMapApp::InitInstance()
{
